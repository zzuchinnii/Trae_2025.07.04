                  ...
                  <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-gray-900">NT$ {product.price}</p>
                      </div>
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">NT$ {total}</dd>
              </div>
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                <dt className="text-base font-medium text-gray-900">總計</dt>
                <dd className="text-base font-medium text-gray-900">NT$ {total}</dd>
              </div>
            </dl>
